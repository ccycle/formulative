...
gumowskiMiraMap MyEquationConstants{..} MyVariable{..} =
  let f x = mu .*. x .+. 2 .*. (1 .-. mu) .*. x .^ 2 ./. (1 .+. x .^ 2); x' = y .+. alpha .*. y .*. (1 .-. sigma .*. y .^ 2) .+. f x
   in MyVariable x' (f x' .-. x)
